  local rage_ref =  gui.Reference("RAGE", "MAIN","AIMBOT")
    ...
    local BaimKey = gui.Keybox( rage_ref, "BaimKey", "BaimKey", 0 )
    local HeadKey = gui.Keybox( rage_ref, "HeadKey", "HeadKey", 0 )
   ...
   -- FBH lua
    ...
    local BaimIfshots, BaimIfHp, HeadAim, autosniper_priority, FakeLatencyEn, FakeLatencyAmount, posadj, autodir -- Other
    ...
    autodir = gui.GetValue("rbot_antiaim_autodir")
    end
